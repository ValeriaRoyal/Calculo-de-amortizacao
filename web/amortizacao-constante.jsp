    ...
    <body> 
        ...
        <div class="fundo">
            ...
            <form class="areaFormulario">
                ...
                <input class="entradaFormulario" type="number" name="SD"/><br/>
                <p class="textoFormulario">Taxa de juros (%):</p>
                <input  class="entradaFormulario" type="number" name="TX"/><br/>
                <p class="textoFormulario">Tempo:</p>
                <input  class="entradaFormulario" type="number" name="T"/><br/>
